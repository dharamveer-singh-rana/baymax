...
if __name__ == "__main__":
    ...
    if speech != 'None':
        ...
        elif ("who is" in speech) or ("wikipedia" in speech)  or ("what is" in speech) or ("who are" in speech) or ("what are" in speech) or ("search" in speech) or ("google" in speech):
        ...
        elif "open google" in speech in speech:
